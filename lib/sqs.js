...
module.exports = ({
  ...
  return {
    ...
    maybeRetrieveFromS3: (message) => {
      ...
      if (
        message.attributes
        && message.attributes.EXTENDED_S3_BUCKET
        && message.attributes.EXTENDED_S3_KEY
      ) {
        promiseChain = S3.getObjectAsync({
          Bucket: message.attributes.EXTENDED_S3_BUCKET,
          Key: message.attributes.EXTENDED_S3_KEY
        });
      }
